                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('manager.inquiries.show', $inquiry) }}" class="text-decoration-none">
...
<div class="row mt-4">
    ...
    <div class="col-md-3">
        <div class="card text-center">
            <div class="card-body">
                <h4 class="text-warning">{{ \App\Models\Inquiry::where('status', 'pending')->count() }}</h4>
    ...
    <div class="col-md-3">
        <div class="card text-center">
            <div class="card-body">
                <h4 class="text-info">{{ \App\Models\Inquiry::where('status', 'processing')->count() }}</h4>
    ...
    <div class="col-md-3">
        <div class="card text-center">
            <div class="card-body">
                <h4 class="text-success">{{ \App\Models\Inquiry::where('status', 'completed')->count() }}</h4>

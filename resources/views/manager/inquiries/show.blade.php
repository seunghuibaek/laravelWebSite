                                    ...
                                    <td>
                                        <form action="{{ route('manager.inquiries.update', $inquiry) }}" method="POST"
                                            ...
                                            <select name="status" class="form-select form-select-sm d-inline-block"
                                                ...
                                                <option
                                                    value="pending" {{ $inquiry->status === 'pending' ? 'selected' : '' }}>
                                                    대기
                                                </option>
                                                <option
                                                    value="processing" {{ $inquiry->status === 'processing' ? 'selected' : '' }}>
                                                    처리중
                                                </option>
                                                <option
                                                    value="completed" {{ $inquiry->status === 'completed' ? 'selected' : '' }}>
                                                    완료
                                                </option>
                                            </select>
                                        </form>
                        ...
                        @foreach($relatedInquiries as $related)
                            <div class="d-flex justify-content-between align-items-start mb-3 pb-3 border-bottom">
                                <div class="flex-grow-1">
                                    <h6 class="mb-1">
                                        <a href="{{ route('manager.inquiries.show', $related) }}"

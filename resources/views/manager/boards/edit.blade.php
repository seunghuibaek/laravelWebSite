    ...
    <div class="col-lg-10">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-edit"></i> 게시판 정보 수정</h5>
            </div>

            <div class="card-body">
                <form action="{{ route('manager.boards.update', $board) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text"
                                   ...
                                   id="board_code"
                                   name="board_code"
                                   value="{{ old('board_code', $board->board_code) }}"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('board_type') is-invalid @enderror"
                                ...
                                <option value="normal" {{ old('board_type', $board->board_type) === 'normal' ? 'selected' : '' }}>일반 게시판</option>
                                <option value="gallery" {{ old('board_type', $board->board_type) === 'gallery' ? 'selected' : '' }}>갤러리 게시판</option>
                            </select>
                            @error('board_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text"
                                   ...
                                   id="upload_folder"
                                   name="upload_folder"
                                   value="{{ old('upload_folder', $board->upload_folder) }}"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('max_file_count') is-invalid @enderror"
                                    ...
                                    required>
                                @for($i = 1; $i <= 5; $i++)
                                    <option value="{{ $i }}" {{ old('max_file_count', $board->max_file_count) == $i ? 'selected' : '' }}>{{ $i }}개</option>
                                @endfor
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number"
                                   ...
                                   id="max_file_size"
                                   name="max_file_size"
                                   value="{{ old('max_file_size', $board->max_file_size) }}"
                                   min="1"
                                   max="102400"
                                   required>
                            @error('max_file_size')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number"
                                   ...
                                   id="sort_order"
                                   name="sort_order"
                                   value="{{ old('sort_order', $board->sort_order) }}"
                                   min="0"
                                   required>
                            @error('sort_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input"
                                           ...
                                           name="use_notice"
                                           value="1"
                                           {{ old('use_notice', $board->use_notice) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input"
                                           ...
                                           value="1"
                                           {{ old('use_file_upload', $board->use_file_upload) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input"
                                           ...
                                           name="use_comment"
                                           value="1"
                                           {{ old('use_comment', $board->use_comment) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input"
                                           ...
                                           value="1"
                                           {{ old('allow_user_write', $board->allow_user_write) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('memo') is-invalid @enderror"
                                  ...
                                  name="memo"
                                  rows="3"
                                  placeholder="게시판에 대한 설명이나 메모를 입력하세요">{{ old('memo', $board->memo) }}</textarea>
                        @error('memo')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>

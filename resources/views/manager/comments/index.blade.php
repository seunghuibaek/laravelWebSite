                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select class="form-select" id="board_id" name="board_id">
                            ...
                            @foreach($boards as $board)
                                <option
                                    value="{{ $board->id }}" {{ request('board_id') == $board->id ? 'selected' : '' }}>
                                    {{ $board->board_name }}
                                </option>
                            @endforeach
                        </select>
    ...
    @if($comments->total() > 0)
        <div class="row mt-4">
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        <h4 class="text-success">{{ Comment::whereDate('created_at', today())->count() }}</h4>
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        <h4 class="text-warning">{{ Comment::where('is_secret', true)->count() }}</h4>
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        <h4 class="text-info">{{ Comment::whereNotNull('parent_id')->count() }}</h4>

@php use App\Models\BoardPost;use App\Models\Comment; @endphp
...
@section('content')
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-3">
            <div class="card text-center">
                <div class="card-body">
                    <h4 class="text-success">{{ BoardPost::where('board_id', $board->id)->whereDate('created_at', today())->count() }}</h4>
        ...
        <div class="col-md-3">
            <div class="card text-center">
                <div class="card-body">
                    <h4 class="text-info">{{ Comment::whereHas('post', function($q) use ($board) { $q->where('board_id', $board->id); })->count() }}</h4>

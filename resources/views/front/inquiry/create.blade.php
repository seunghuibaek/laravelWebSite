                ...
                <div class="col-lg-4 mb-4">
                    <div class="card h-100 border-0 shadow-sm text-center">
                        <div class="card-body">
                            ...
                            <h5>이메일</h5>
                            <p class="text-muted">{{ SystemSetting::get('admin_email', 'admin@example.com') }}</p>
                            <a href="mailto:{{ SystemSetting::get('admin_email', 'admin@example.com') }}"
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card h-100 border-0 shadow-sm text-center">
                        <div class="card-body">
                            ...
                            <h5>전화</h5>
                            <p class="text-muted">{{ SystemSetting::get('contact_phone', '02-1234-5678') }}</p>
                            <a href="tel:{{ SystemSetting::get('contact_phone', '02-1234-5678') }}"
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card h-100 border-0 shadow-sm text-center">
                        <div class="card-body">
                            ...
                            <h5>주소</h5>
                            <p class="text-muted">{{ SystemSetting::get('contact_address', '서울시 강남구') }}</p>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <form action="{{ route('inquiry.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    <label for="message" class="form-label">문의 내용 <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-4">
                                    <div class="alert alert-info">
                                        ...
                                        <ul class="mb-0 small">
                                            ...
                                            <li><strong>동의거부권:</strong> 개인정보 수집에 동의하지 않을 수 있으나, 이 경우 문의 서비스 이용이 제한됩니다.
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="accordion" id="faqAccordion">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            네, {{ SystemSetting::get('admin_email', 'admin@example.com') }}로
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            네, {{ SystemSetting::get('contact_phone', '02-1234-5678') }}로
                                            전화 주시면 상담 가능합니다.
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#message').on('input', function () {
                ...
                $charCounter.text(`${currentLength}/${maxLength}자`);

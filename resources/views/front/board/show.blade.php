    ...
    <div class="container">
        <div class="row">
                ...
                <article class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                            <div>
                                <button type="button" class="btn btn-outline-danger like-btn" data-post-id="{{ $post->id }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-2 pb-2 border-bottom">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div>
                                    <a href="{{ route('board.show', [$board->board_code, $prevPost]) }}" class="text-decoration-none">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div>
                                    <a href="{{ route('board.show', [$board->board_code, $nextPost]) }}" class="text-decoration-none">
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="comment-item p-3 mb-3">
                            ...
                            <div class="mt-3">
                                <button type="button" class="btn btn-sm btn-outline-secondary comment-toggle" data-comment-id="{{ $comment->id }}">
                        ...
                        <div class="comment-form mt-4">
                            ...
                            <form action="{{ route('comments.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <textarea class="form-control" name="content" rows="4" placeholder="댓글을 입력하세요..." required></textarea>
                                </div>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="{{ route('board.index', $board->board_code) }}" class="btn btn-outline-primary">
                ...
                <!-- Recent Posts -->
                @php
                    $recentPosts = \App\Models\BoardPost::where('board_id', $board->id)
                        ->where('id', '!=', $post->id)
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start mb-3 pb-3 border-bottom">
                            <div class="flex-grow-1">
                                <h6 class="mb-1">
                                    <a href="{{ route('board.show', [$board->board_code, $recentPost]) }}" class="text-decoration-none">
                                        {{ Str::limit($recentPost->title, 25) }}
                                    </a>
                                </h6>
                                <small class="text-muted">
                                    {{ $recentPost->author_name }} | {{ $recentPost->created_at->format('m-d') }}
                                </small>
                            </div>
                        </div>
                        @endforeach
